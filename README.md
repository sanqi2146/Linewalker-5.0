...
| 版本 | 日期 | 主要改动 |
|---|---|---|
| v5.0 | 2025-07 | 统一版本号、Flash扩展(RSP/TL)、出弯复位双阈值滞回、死代码清理、十字禁用、新图标 |
| v4.9 | 2025-06 | S=10位上报、E/C偏差修正、锁存/转弯速度可保存 |
| v4.5 | 2025-05 | Flutter App Material You 3 重写、8路I2C巡线 |
| v3.x | 2025-03 | 4路巡线 + 超声波 + 舵机 |
